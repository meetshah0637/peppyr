...
try {
  ...
  if (!existsSync(serviceAccountPath)) {
    ...
    console.error('   Make sure the file exists at: server/service-account.json');
    process.exit(1);
  }
    ...
    try {
      ...
      if (userId) {
        ...
        if (!confirmAll) {
          ...
          console.log('   Example: node clear-contacts.js --confirm-all');
